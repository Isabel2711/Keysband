...
if (!empty($rfid_uid)) {
    ...
    if ($result->num_rows > 0) {
        ...
        echo json_encode(array("message" => "El usuario con este RFID ya esta registrado.", "rfid" => $rfid_uid));
    } else {
        ...
        if ($conn->query($insert_query) === TRUE) {
            ...
            echo json_encode(array("message" => "Usuario registrado existosamente.", "rfid" => $rfid_uid));
        } else {
